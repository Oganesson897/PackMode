...
public class ConfigScreen extends GuiScreen {
    ...
    public ConfigScreen(GuiScreen lastScreen) {
        ...
        configuration = PMConfig.getConfiguration();
        configuration.load();
    ...
    public void initGui() {
        ...
        exitBtn = new GuiButtonExt(3, this.width / 2 - 155, this.height - 80, 150, 20, I18n.format("packmodemenu.options.save_restart"));
        exitBtn.enabled = !mode.equals(defaultMode);
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.id == switchBtn.id) {
            ...
            configuration.save();
            Minecraft.getMinecraft().displayGuiScreen(this.lastScreen);
            throw new RuntimeException("PackMode Reset");
        } else {
            Minecraft.getMinecraft().displayGuiScreen(this.lastScreen);
        }
    }
