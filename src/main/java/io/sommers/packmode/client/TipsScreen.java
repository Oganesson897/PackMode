package io.sommers.packmode.client;
...
public class TipsScreen extends GuiScreen {
    public static boolean wasOpened;

    public final String title = TextFormatting.BOLD + "! Warning from PackMode !";
    public final List<String> messages;
    private List<String> lines;
    private int lastWidth;

    public TipsScreen(List<String> messages) {
    ...
    public void actionPerformed(GuiButton button) {
        if (button.id == 0) {
            this.mc.displayGuiScreen(new ConfigScreen(new GuiMainMenu()));
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, buttonX + 100, buttonY, I18n.format("gui.to_modify")));
        this.buttonList.add(new GuiButton(1, buttonX - 100, buttonY, I18n.format("gui.ignore")));
    }
}
